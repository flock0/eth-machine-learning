...
if __name__=='__main__':
    ...
    kernelPCAKernel = ['rbf']
    percentile = np.array([15, 17, 20])
    scoreFunc = [f_classif]
    lrC = np.array([0.1, 0.5, 1.0, 5])
    svmC = np.array([0.01, 0.05, 0.1, 0.15])
    svmGamma = np.array([2.0, 1.0, 0.01, 0.005, 0.001])
    ...
    rfNEstimators = np.array([100, 125, 150, 175])
    ...
    gbNEstimators = np.array([100, 500,900,1300])
